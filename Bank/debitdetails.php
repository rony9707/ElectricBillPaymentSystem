...
<div id="header">
	...
	<div id="main">
		...
		<center><h1><u><b>Your Debit Details</b></u></h1>
			...
			<tr>
			<td><b>Balance:</td>
			<td><input type="textview" class="ushow_id" readonly="readonly" value="<?php echo $_SESSION['balancedebit'] ?>"></input></td>
			</tr>
			
			<tr>
			<td><b>Credit Card Number:</td>
            <td>
            <input type="textview"   readonly="readonly" class="card_number" value="<?php echo $_SESSION['d1'] ?>"        ></input>
            
            <input type="textview"   readonly="readonly" class="card_number" value="<?php echo $_SESSION['d2'] ?>"       ></input>
        
           <input type="textview"   readonly="readonly" class="card_number" value="<?php echo $_SESSION['d3'] ?>"      ></input>
                    
            <input type="textview"   readonly="readonly" class="card_number" value="<?php echo $_SESSION['d4'] ?>"       ></input>
            </td>
			</tr>
			...
			<td>
                <input type="textview" class="expdate" readonly="readonly" value="<?php echo $_SESSION['yeardebit'] ?>"></input>
                <input type="textview"   readonly="expdate" class="expdate" value="<?php echo $_SESSION['monthdebit'] ?>"        ></input>
            </td>
			</tr>
			
			<tr>
			<td><b>CVV:</td>
			<td><input type="textview" class="ushow_id" readonly="readonly" value="<?php echo $_SESSION['cvvdebit'] ?>"></input></td>
			</tr>
			</table>
