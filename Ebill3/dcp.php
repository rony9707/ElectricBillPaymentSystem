...
<head>
	...
	<script type="text/javascript">
		...
		function validate()
		{
			...
			//Debit card number must be in numbers
			var pno=document.getElementById("DCN").value;
			if(isNaN(pno))
			{
			alert("Debit Card Number must be in numbers");
			return false;
			}
...
<div id="header">
	...
	<div class="middle-sub1">
		<center><b>
		<h1><u>Enter Debit Card Details</u></h1><br>
		<form class="form" action="dcp.php" method="post" enctype="multipart/form-data" onsubmit="return validate()"  > 
		<table>
           ...
           <input type="text"  onkeypress="return isNumber(event)" class="card_number" name="c3" id="DCN" maxlength="4"   required   ></input>
			...
			<tr>
			<td><b>CVV:</td>
			<td><input type="text" onkeypress="return isNumber(event)" class="ushow_id" name="cvv" maxlength="4" id="CVV" placeholder="Enter your CVV" required   ></input></td>
			</tr>
			
			<tr>
			<td><b>Name of Owner of Card:</td>
			<td><input type="text" onkeypress="return onlyAlphabets(event,this);" class="ushow_id" name="cardowner" id="name" placeholder="Enter your Card Name" required   ></input></td>
			</tr>
			...
			<input type="submit" name="debit_cp" class="Register" value="PAY"><br>
       ...
       <div id="marquee-msg">
        ...
        $paid="PAID";  
	       ...
	       $query= "select * from debit where c1='$c1' && c2='$c2' && c3='$c3' && c4='$c4' && month='$month' 
            ...
            if(mysqli_num_rows($query_run)>0)
            {
                ...
                $query="select balance from debit where c1='$c1' && c2='$c2' && c3='$c3' && c4='$c4' && month='$month' 
                        && year='$year' && fullname='$nameofcard' && cvv='$cvv';   ";
                $query_run=mysqli_query($conn,$query);
                ...
                $updatequery= "UPDATE  debit  SET balance='$newbankbalance' where c1='$c1' && c2='$c2' && c3='$c3' && c4='$c4' && month='$month' 
                        && year='$year' && fullname='$nameofcard' && cvv='$cvv';   ";
