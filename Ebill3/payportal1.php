...
<div id="header">
	...
	<div class="middle-sub1">
		<center><b>
		<h1><u>Select Payment Method</u></h1><br>
		
		<h2>Pay using:<h2>
		<table>
		<td>
		<b>
		<input type="button" class="Register" value="Credit Card" onclick="window.location.href='ccp.php'"><br>
		
		<input type="button" class="Register" value="Debit Card" onclick="window.location.href='dcp.php'"><br>
